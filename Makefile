# Generic Makefile prototype. Author Gerallt Franke.
...
cleanDebug:
	@- ${MAKE} -f ${MAKEFILE} ${.TARGETS}
	@- ${CH_DIR} ../ && ${MAKE} -f ${MAKEFILE} ${.TARGETS} DO_CHDIR=Backward
cleanRelease:
	@- ${MAKE} -f ${MAKEFILE} ${.TARGETS}
	@- ${CH_DIR} ../ && ${MAKE} -f ${MAKEFILE} ${.TARGETS} DO_CHDIR=Backward
clean:
	${PWD_SHOW}
	@- ${MAKE} -f ${MAKEFILE} ${.TARGETS} DO_CHDIR=None # &>/dev/null
	@- ${CH_DIR} ../ && ${MAKE} -f ${MAKEFILE} ${.TARGETS} DO_CHDIR=Backward # &>/dev/null # BSD make always chdirs.
options:
	@- ${MAKE} -f ${MAKEFILE} ${.TARGETS}
help:
	@- ${MAKE} -f ${MAKEFILE} ${.TARGETS}
